...
export default function Screener() {
  ...
  const result = useMemo(() => {
    ...
    const config = customWeights
      ? { ...currentStrategy, dimensions: customWeights }
      : currentStrategy
  ...
  return (
    <div className="page screener">
      ...
      {currentStrategy?.description && (
        <p className="strategy-desc">{currentStrategy.description}</p>
      )}
      ...
      <div className="screener-layout">
        ...
        <div className="screener-results">
          {marketLoading && <div className="loading">加载中...</div>}
          {!marketLoading && !result && <div className="empty">暂无数据</div>}
